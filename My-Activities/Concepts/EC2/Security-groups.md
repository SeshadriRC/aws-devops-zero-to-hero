...
- TCP connection was already established before you removed the SG rule, and AWS allows existing (ESTABLISHED) connections to continue. This is called stateful connection tracking. Eg: Prometheus Scraping continued
